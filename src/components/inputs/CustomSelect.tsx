...
const CustomSelector: React.FC<CustomSelectorProps> = ({
  ...
  return (
    <div className="w-full max-w-md min-w-[200px]">
      ...
      {/* Selector Container */}
      <div className="w-full h-[41px] border border-[#D6DDEB] bg-transparent px-3 py-2 transition-all duration-300 ease-in-out hover:border-sec focus-within:border-sec ">
        {/* Select Element */}
        <select
